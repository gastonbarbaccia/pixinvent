      ...
      <div class="navbar-container content">
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <ul class="nav navbar-nav mr-auto float-left">
            <a href="users.php" class="btn btn-primary" style="margin-right: 5px;">New user</a>
            <a href="properties.php" class="btn btn-primary">New property</a>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        ...
                        <a href="dashboard_edit.php" class="btn btn-secondary"><i class="fa fa-pencil-square-o"
