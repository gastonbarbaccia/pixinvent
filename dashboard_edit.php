            ...
            <ul class="mega-dropdown-menu dropdown-menu row p-1">
              ...
              <li class="col-md-5 px-2">
                ...
                <ul class="row mt-2">
                  ...
                  <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3 mt-75 mt-xl-0" href="app-todo.php"
...
<div class="dropdown-divider"></div><a class="dropdown-item" href="index.php"><i
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header row" style="padding-left: 1%;font-size: 150%;">
      ...
      <form method="POST" action="#">
        <table>
            ...
            <td style="width: 20%">
              <div class="form-group">
                ...
                <select name="select" class="form-control">
                  ...
                  <option value="value1">Out of term</option>
                  <option value="value2">Paid out</option>
                </select>
              </div>
            </td>
            <td style="width: 20%">
          ...
          <tr>
            ...
            <td style="width: 20%">
              <div class="form-group">
                <label for="exampleInputPassword1">Method of payment</label>
                <select name="select" class="form-control">
                  <option value="value0">-</option>
                  <option value="value1">Credit card</option>
                  <option value="value2">Transfer bank</option>
                  <option value="value2">Debit</option>
                  <option value="value0">Cash</option>
                </select>
              </div>
            </td>
          </tr>
        ...
        <a class="btn btn-primary" href="dashboard.php">Cancel</a>
