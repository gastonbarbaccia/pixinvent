            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    <ul class="nav navbar-nav mr-auto float-left">
                        ...
                        <a href="properties_new.php" class="btn btn-primary">New property</a>
                        <ul class="mega-dropdown-menu dropdown-menu row p-1">
                            <li class="col-md-4 bg-mega p-2">
                                ...
                                <p class="text-white line-height-2">Candy canes bonbon toffee. Cheesecake dragée gummi
                                    bears chupa
                                    chups powder bonbon. Apple pie cookie sweet.</p>
                            ...
                            <li class="col-md-5 px-2">
                                ...
                                <ul class="row mt-2">
                                    ...
                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="app-chat.php"
                                            target="_blank"><i
                                    ...
                                    <li class="col-12 col-xl-6 pl-0">
                                        <ul class="mega-component-list">
                                            <li class="mega-component-item"><a class="mb-1 mb-xl-2"
                                                    href="component-alerts.php" target="_blank">Alert</a></li>
                                            <li class="mega-component-item"><a class="mb-1 mb-xl-2"
                                                    href="component-callout.php" target="_blank">Callout</a></li>
                                            <li class="mega-component-item"><a class="mb-1 mb-xl-2"
                                                    href="component-buttons-basic.php" target="_blank">Buttons</a></li>
                                            <li class="mega-component-item"><a class="mb-1 mb-xl-2"
                                                    href="component-carousel.php" target="_blank">Carousel</a></li>
                                        </ul>
                                    </li>
                                    <li class="col-12 col-xl-6 pl-0">
                                        <ul class="mega-component-list">
                                            <li class="mega-component-item"><a class="mb-1 mb-xl-2"
                                                    href="component-dropdowns.php" target="_blank">Drop Down</a></li>
                                            <li class="mega-component-item"><a class="mb-1 mb-xl-2"
                                                    href="component-list-group.php" target="_blank">List Group</a></li>
                                            <li class="mega-component-item"><a class="mb-1 mb-xl-2"
                                                    href="component-modals.php" target="_blank">Modals</a></li>
                                            <li class="mega-component-item"><a class="mb-1 mb-xl-2"
                                                    href="component-pagination.php" target="_blank">Pagination</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="dropdown dropdown-user nav-item"><a
                            ...
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                    href="profile.php"><i class="fa fa-user"></i> Edit Profile</a>
                                <div class="dropdown-divider"></div><a class="dropdown-item"
                                    href="index.php"><i class="fa fa-sign-out"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <span>Yapeyu 1255</span>
                                            </td>
                                            <td class="align-middle">
                                                <span>Grand Bourg</span>
                                            </td>
                                            <td class="align-middle" style="text-align: center;font-size: 20px;">
                                            ...
                                            <td class="align-middle">
                                                ...
                                                <a href="properties_edit.php" class="btn btn-secondary"><i class="fa fa-pencil-square-o"
                                                        aria-hidden="true"></i></a>
