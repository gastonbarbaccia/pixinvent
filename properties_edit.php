      ...
      <form method="POST" action="#">
        <table>
          ...
          <tr>
            <td style="width: 20%">
              <div class="form-group">
                <label for="exampleInputEmail1">method of payment</label>
                <input type="text" class="form-control" id="exampleInputEmail1">
              </div>
            </td>
            <td style="width: 20%">
          ...
          <tr>
            <td style="width: 20%">
              <div class="form-group">
                <label for="exampleInputEmail1">Out of payment</label>
                <input type="text" class="form-control" id="exampleInputEmail1">
              </div>
            </td>
            <td style="width: 20%">
        ...
        <a class="btn btn-primary" href="properties.php">Cancel</a>
