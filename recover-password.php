...
<!-- Mirrored from pixinvent.com/stack-responsive-bootstrap-4-admin-template/html/ltr/vertical-modern-menu-template/recover-password.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jan 2022 22:31:22 GMT -->
                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal"
                                            action="https://pixinvent.com/stack-responsive-bootstrap-4-admin-template/html/ltr/vertical-modern-menu-template/login-simple.php"
                                            novalidate>
                                ...
                                <div class="card-footer border-0">
                                    <p class="float-sm-left text-center"><a href="index.php"
                                            class="card-link">Login</a></p>
                                    <p class="float-sm-right text-center">New to Stack ? <a href="register.php"
