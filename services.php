      ...
      <div class="navbar-container content">
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <ul class="nav navbar-nav mr-auto float-left">
            <a href="services_new.php" class="btn btn-primary" style="margin-right: 5px;">New service</a>
            <a href="services_task.php" class="btn btn-primary">New task</a>
                ...
                <table class="table" id="myTable" name="myTable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        <span>1168171725</span>
                      </td>
                      <td class="align-middle">
                        <span>Electricista</span>
                      </td>
                      <td class="align-middle">
                        <span>Llamar siemp</span>
                      </td>
                      <td class="align-middle">
                        <div class="div">
                          <a href="#" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                          <a href="services_edit.php" class="btn btn-secondary"><i class="fa fa-pencil-square-o"
                              aria-hidden="true"></i></a>
                           <a href="services_user.php" class="btn btn-secondary"><i class="fa fa-eye" aria-hidden="true"></i></a>
                        </div>
                      </td>
                    </tr>
                    <tr>
