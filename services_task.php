...
<div class="dropdown-divider"></div><a class="dropdown-item" href="index.php"><i
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      ...
      <form  method="GET" action="services_user.php">
        <table>
          <tr>
            <td style="width: 20%">
            ...
            <td style="width: 20%">
              ...
              <div class="form-group">
                ...
                <select name="select" class="form-control">
                  ...
                  <option value="value1">In progress</option>
          ...
          <tr>
            <td style="width: 20%">
              <div class="form-group">
                ...
                <select name="select" class="form-control">
                  <option value="value0"></option>
                  <option value="value1">Shwell Flintof 1</option>
                  <option value="value2">Shwell Flintof 2</option>
                  <option value="value3">Shwell Flintof 3</option>
                </select>
              </div>
            </td>
          </tr>
        ...
        <a class="btn btn-primary" href="services.php">Cancel</a>
