      ...
      <div class="navbar-container content">
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <ul class="nav navbar-nav mr-auto float-left">
            <a href="services_task_2.php" class="btn btn-primary" style="margin-right: 5px;">New task</a>
            <ul class="mega-dropdown-menu dropdown-menu row p-1">
              <li class="col-md-4 bg-mega p-2">
                <h3 class="text-white mb-1 font-weight-bold">Mega Menu Sidebar</h3>
                <p class="text-white line-height-2">Candy canes bonbon toffee. Cheesecake dragée gummi bears chupa
...
<div class="dropdown-divider"></div><a class="dropdown-item" href="index.php"><i
            ...
            <form>
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                  placeholder="Enter email" value="Gaston Barbaccia" readonly>
              </div>
              <div class="form-group">
                <label for="exampleInputPassword1">Service</label>
                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Password" value="Taxiboy" readonly>
              </div>
            </form>
          </td>
          <td style="width: 20%"> 
            <form>
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                  placeholder="Enter email" value="gastonbarbaccia@hotmail.com" readonly>
             </div>
              <div class="form-group">
                <label for="exampleInputPassword1">Phone</label>
                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Phone" value="1168172725" readonly>
              </div>
            </form>
          </td>
        </tr>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        <div class="div">
                          ...
                          <a href="services_task_edit.php" class="btn btn-secondary"><i class="fa fa-pencil-square-o"
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <div class="div">
                          <a href="#" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                          <a href="#" class="btn btn-secondary"><i class="fa fa-pencil-square-o"
                              aria-hidden="true"></i></a>
                        </div>
                      </td>
                    </tr>
  ...
  <footer class="footer footer-static footer-light navbar-border">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span
        ...
        class="float-md-right d-none d-lg-block">Hand-crafted & Made with <i class="feather icon-heart pink"></i></span>
    </p>
  </footer>
  <!-- END: Footer-->
